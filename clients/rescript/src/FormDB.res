...
let fromEnv = () => {
  ...
  let baseUrl = %raw(`Deno.env.get("FORMDB_URL") || "http://localhost:8080"`)
  let apiKey = %raw(`Deno.env.get("FORMDB_API_KEY")`)
...
module Types = FormDB_Types
module Query = FormDB_Query
