...
Distributed computing features for Lith including cluster coordination,
consensus, sharding, and replication.
...
|Cluster |`+Lith_Distributed_Cluster.res+` |Node discovery and
membership
...
Raft-based distributed consensus for leader election and log
replication.
