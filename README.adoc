...
See link:formbd.scm[formbd.scm] for structured open questions with acceptance criteria:
...
* link:formbd.scm[formbd.scm] - Machine-readable specification
...
=== Domain-Specific
* link:docs/WP05_interactive_documentary.md[WP05] - FormBD for Interactive Documentary/Journalism

== Related Projects

* https://github.com/hyperpolymath/fqldt[FQLdt] - Dependently-typed FQL (same database, compile-time proofs)
* https://github.com/hyperpolymath/formbd-studio[FormBD Studio] - Zero-friction GUI for non-technical users
* https://github.com/hyperpolymath/bofig[BoFIG] - Evidence graph for investigative journalism
* https://github.com/hyperpolymath/zotero-formbd[Zotero-FormBD] - Post-truth reference manager with PROMPT scores
