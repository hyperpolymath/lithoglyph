...
- This repository (`hyperpolymath/lithoglyph`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/lithoglyph/security/advisories)
...
When using Lithoglyph, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/lithoglyph/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/lithoglyph/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/lithoglyph/discussions) |
...
*Thank you for helping keep Lithoglyph and its users safe.* 🛡️
