...
/**
 * FormDB API Specification Types
 *
...
/** FormDB API specification */
let formdbSpec: apiSpec = {
  name: "FormDB",
  version: "0.0.6",
  baseUrl: "/v1",
  description: "FormDB REST API - Narrative-first, reversible, audit-grade database",
  endpoints: [
    // Query
    {
      name: "query",
