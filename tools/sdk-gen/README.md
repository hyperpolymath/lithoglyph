# FormDB SDK Generator

Code generator for FormDB client SDKs.

## Overview

This tool generates type-safe client libraries from the FormDB API specification. It supports multiple target languages and produces idiomatic code for each.
...
- `FormDB_Types.res` - Type definitions (enums, records)
- `FormDB.res` - Client with all API methods

### PHP

- `Types.php` - Type definitions (enums, classes)
- `FormDBClient.php` - Client skeleton
