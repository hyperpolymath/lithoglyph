...
Visual proof exploration - Step-by-step query debugging - Schema
evolution verification - Constraint explanation

=== Related Repositories

* https://github.com/hyperpolymath/lithoglyph[lithoglyph] - Core
database (monorepo)
* https://github.com/hyperpolymath/gnpl[gql-dt] - Dependently-typed
query language
* https://github.com/hyperpolymath/formbase[formbase] - Airtable
alternative
