...
├─────────────────────────────────────────────────────────────┤
│  GQLdt (github.com/hyperpolymath/gnpl)                     │
│  ├── Lean 4 type checker                                    │
...
See https://github.com/hyperpolymath/lithoglyph/blob/main/spec/self-normalizing.adoc[Lith Self-Normalizing Spec] and https://github.com/hyperpolymath/gnpl/blob/main/spec/normalization-types.md[GQLdt Normalization Types].
...
* https://github.com/hyperpolymath/gnpl[GQLdt] - Dependently-typed Form Query Language
* https://github.com/hyperpolymath/gnpl/blob/main/spec/normalization-types.md[GQLdt Normalization Types] - Type-encoded functional dependencies and normal forms
