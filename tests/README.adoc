...
Comprehensive testing framework for Lith including property-based tests,
fuzz testing, integration tests, and end-to-end tests.
...
Fuzz testing discovers edge cases and potential crashes through random
input mutation.
...
*API Suite:* - Health check - Collection CRUD - Document CRUD - Query
with WHERE - EXPLAIN query - INTROSPECT schema

*Sync Suite:* - Sync create/update/delete - Provenance tracking -
Bidirectional sync - Conflict resolution - Batch sync
