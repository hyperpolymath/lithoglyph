 ...
 *
 * Usage:
 *   deno run --allow-read --allow-env src/FormDB_Fuzz_Main.res.js
 *   deno run --allow-read --allow-env src/FormDB_Fuzz_Main.res.js --iterations 1000
 */

open FormDB_Fuzz_Types
open FormDB_Fuzz_FDQL
open FormDB_Fuzz_Runner
...
let main = () => {
  ...
  Js.Console.log("======================================")
  Js.Console.log("FormDB Fuzz Test Suite")
  Js.Console.log("======================================")
