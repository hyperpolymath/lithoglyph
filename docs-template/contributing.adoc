...
= Contributing — Lithoglyph
:revdate: 2026-MM-DD

== Audience

Developers working *on* `Lithoglyph`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/Lithoglyph.git
cd Lithoglyph
...
* Bugs in `Lithoglyph`: file at `hyperpolymath/Lithoglyph/issues`.
