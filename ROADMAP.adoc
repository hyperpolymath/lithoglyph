...
* [x] `formbd.scm` - Unified specification
...
* [x] Fixed-size block implementation (`core-forth/src/formbd-blocks.fs`)
...
* [x] Append-only journal (`core-forth/src/formbd-journal.fs`)
...
* [x] Document collection support (`core-forth/src/formbd-model.fs`)
