...
%% FormDB NIF - Erlang interface to FormDB
%%
%% This module loads the Zig NIF and provides Erlang functions
%% to interact with FormDB.
...
init() ->
    ...
    SoPath = filename:join(PrivDir, "formdb_nif"),
