...
**Date:** 2026-02-04
**Milestone:** M11 (HTTP API for FormBD-Geo & FormBD-Analytics)
**Status:** Draft Specification

## Overview

M11 adds HTTP/REST API endpoints to Lithoglyph for remote access to:
- FormBD-Geo (geospatial data with provenance)
...
2. NIF integration (reuse FormBD-BEAM)
...
1. Create Phoenix project: `mix phx.new formdb_http --no-html --no-assets --database=false`
2. Add FormBD-BEAM NIF dependency
...
**Dependencies:** FormBD-BEAM (complete), Phoenix/Plug (to be installed)
