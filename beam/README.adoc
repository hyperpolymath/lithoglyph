...
BEAM (Erlang/Gleam/Elixir) bindings for https://github.com/hyperpolymath/lithoglyph[Lithoglyph] - the narrative-first database.
...
* https://github.com/hyperpolymath/lithoglyph[Lithoglyph] - The database engine
