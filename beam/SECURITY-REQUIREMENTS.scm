...
;; =================================================================
;; IMPLEMENTATION PRIORITIES FOR FORMDB
;; =================================================================

(define formdb-security-implementation
  '(
...
;; =================================================================
;; FORMDB CRYPTO LIBRARY STACK
;; =================================================================

(define formdb-crypto-stack
  '(
...
(provide 'user-security-requirements
         'formdb-security-implementation
         'formdb-crypto-stack
