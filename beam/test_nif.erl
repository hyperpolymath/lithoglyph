...
%% Quick test of FormDB NIF

main(_) ->
    io:format("~n=== FormDB-BEAM NIF Test ===~n~n"),
    ...
    case erlang:load_nif("./priv/formdb_nif", 0) of
        ok ->
    ...
    try formdb_nif:db_open(DbPath) of
        {ok, DbRef} ->
            ...
            try formdb_nif:db_close(DbRef) of
                ok ->
