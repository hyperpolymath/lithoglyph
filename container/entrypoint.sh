...
# Lithoglyph container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping lithoglyph..."
...
# Examples:
#   exec /app/lithoglyph
#   exec /app/release/bin/lithoglyph start
#   exec /app/lithoglyph serve --host "${APP_HOST}" --port "${APP_PORT}"
