...
: "${LITH_AUTH_JWT_SECRET:?inject the JWT signing secret}"
: "${LITH_ENCRYPTION_MASTER_KEY:?inject the encryption master key}"
: "${LITH_OIDC_CLIENT_SECRET:?inject the OIDC client secret}"
export LITH_AUTH_JWT_SECRET LITH_ENCRYPTION_MASTER_KEY LITH_OIDC_CLIENT_SECRET
----
...
jwt_secret = "secret/data/lith/jwt-secret" # hypatia: allow security_errors/secret_detected -- Vault lookup path, not the secret value
oidc_secret = "secret/data/lith/oidc-client" # hypatia: allow security_errors/secret_detected -- Vault lookup path, not the secret value
...
jwt_secret = "lith/jwt-secret" # hypatia: allow security_errors/secret_detected -- AWS lookup path, not the secret value
oidc_secret = "lith/oidc-client" # hypatia: allow security_errors/secret_detected -- AWS lookup path, not the secret value
----
