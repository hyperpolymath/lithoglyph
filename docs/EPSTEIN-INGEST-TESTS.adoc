...
[[spdx-license-identifier-cc-by-sa-40]]
== SPDX-License-Identifier: CC-BY-SA-4.0

[[author-jonathan-da-jewell]]
...
[[extracted-from-the-master-pathway-bofigdocsepstein-files-work-pathwaymd]]
== Extracted from the master pathway: bofig/docs/EPSTEIN-FILES-WORK-PATHWAY.md

[[this-file-contains-only-the-lithoglyph-specific-phases-2125-44-52]]
== This file contains only the Lithoglyph-specific phases (2.1–2.5, 4.4, 5.2).

[[phase-2-lithoglyph-ingest--storage-weeks-410]]
=== Phase 2: Lithoglyph Ingest & Storage (Weeks 4–10)

[[step-21-zig-0152-http-api-migration-l1]]
...
* [ ] T-ZIG-3: GQL INSERT via HTTP returns 200 {plus} created record ID
...
[[step-22-evidence-collection-schema-l3]]
==== Step 2.2: Evidence Collection Schema (L3)

Collections: `bofig++_++evidence`, `bofig++_++claims`, `bofig++_++relationships`

*Tests:*

* [ ] T-EVD-1: CREATE bofig++_++evidence collection succeeds
...
* [ ] T-EVD-5: All mutations have actor {plus} rationale (Lithoglyph invariant)

[[step-23-financial-transaction-collection-l4]]
...
[[step-24-entity-collection--co-reference-resolution-l5]]
==== Step 2.4: Entity Collection {plus} Co-Reference Resolution (L5)
...
[[step-25-docudactyl--lithoglyph-ingest-bridge-d2--l6]]
==== Step 2.5: Docudactyl → Lithoglyph Ingest Bridge (D2 {plus} L6)
...
** OCR confidence 90{plus} → Provenance score 0.8{plus}
** Multiple corroborating documents → Replicability score increases
** Court filing (official source) → Publication score 0.9{plus}
...
* [ ] T-TCR-4: Source retraction → credibility impact {plus} retraction logged
...
|2.4 |Entity {plus} Co-Ref |TODO |0/6 |0/2
...
* *Lithoglyph integration role:* `docs/INTEGRATION-PLAN-LITHOGLYPH.adoc` (this repo)
