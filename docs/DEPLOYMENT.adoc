...
FormDB is in active development. This guide describes the intended deployment model. Some features are planned but not yet implemented (marked with 🚧).
====
...
----
         ...
         ▼                   ▼                   ▼
┌─────────────────┐ ┌─────────────────┐ ┌─────────────────┐
│  FormDB Node 1  │ │  FormDB Node 2  │ │  FormDB Node 3  │
