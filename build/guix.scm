...
;;
;; Guix package definition for Lithoglyph
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace Lithoglyph and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/Lithoglyph")
  (synopsis "Provenance-first database: a Forth model core, a Zig ABI bridge, a Factor query runtime and a BEAM control plane")
