...
Advanced analytics features for Lith including aggregations, time series
analysis, window functions, and visualization exports.
...
|Aggregations |`+Lith_Analytics_Aggregations.res+` |Statistical
aggregations
