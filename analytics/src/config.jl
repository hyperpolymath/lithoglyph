...
"""
Configuration management for FormBD-Analytics
"""

"""
FormBD connection configuration
"""
Base.@kwdef struct FormBDConfig
...
Base.@kwdef struct Config
    formbd::FormBDConfig = FormBDConfig()
...
function load_config(path::String)::Config
    ...
    return Config(formbd=formbd, server=server, storage=storage, sync=sync)
end
